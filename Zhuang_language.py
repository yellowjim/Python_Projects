...
def main():
    ...
    cursor = dmpc.cursor()
    cursor.execute("SELECT f_id,f_idcode,f_name,f_nationalname from tb_place_info where f_region like '450108%' and f_language='壮语' and (f_nationalname='' or f_nationalname is null)")
